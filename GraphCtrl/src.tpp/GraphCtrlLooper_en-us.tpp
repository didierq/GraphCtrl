...
[s1;:Upp`:`:GraphDraw`_ns`:`:GraphCtrlLooper`:`:class: [@(0.0.255)3 class][3 _][*3 GraphCtr
lLooper][3 _:_][@(0.0.255)3 public][3 _][*@3;3 LocalLoop]&]
...
[s4; &]
[s5;:Upp`:`:GraphDraw`_ns`:`:GraphCtrlLooper`:`:WhenMouseMove: [_^MouseLocalLoopCB^ Gra
phDraw`_ns`::MouseLocalLoopCB]_[* WhenMouseMove]&]
