...
[s1;:Upp`:`:GraphDraw`_ns`:`:TickMark`:`:class:%- [@(0.0.255)3 class][3 _][*3 TickMark]&]
...
[s4;%- &]
[s5;:Upp`:`:GraphDraw`_ns`:`:TickMark`:`:UpdateTick`(`):%- [@(0.0.255) virtual] 
[@(0.0.255) void]_[* UpdateTick]()&]
...
[@(0.0.255) const]_[@(0.0.255) int]_[*@3 scale]_`=_[@3 1])_[@(0.0.255) const]&]
