...
[s4;%- &]
[s5;:Upp`:`:GraphDraw`_ns`:`:TypeScreenCoord`:`:typedef:%- [@(0.0.255) typedef]_[_^int32^ U
pp`::int32]_[* TypeScreenCoord]&]
[s2; Type used for physical coordinates : the ones used for screen 
positions (pixels)&]
[s3;%- &]
[s4;%- &]
[s5;:Upp`:`:GraphDraw`_ns`:`:TypeGraphCoord`:`:typedef:%- [@(0.0.255) typedef]_[@(0.0.255) d
ouble]_[* TypeGraphCoord]&]
[s2; Type used for logical coordinates (the same one as you`'re data)&]
[s3;%- &]
[s0;*@7;4 &]
[ {{10000@(113.42.0) [s0; [*@7;4 Class LinearConverter]]}}&]
[s1;:Upp`:`:GraphDraw`_ns`:`:LinearConverter`:`:class:%- [@(0.0.255)3 class][3 _][*3 Linear
Converter]&]
[s2; Helper class used to manage screen coordinate conversion. It 
does a linear conversion.&]
[s2; Also manages axis inversion&]
[s3;%- &]
[s0;*@7;4 &]
[ {{10000@(113.42.0) [s0; [*@7;4 Class CoordinateConverter]]}}&]
[s1;:Upp`:`:GraphDraw`_ns`:`:CoordinateConverter`:`:class:%- [@(0.0.255)3 class][3 _][*3 Co
ordinateConverter]&]
[s2; Class dedicated to managing conversion between logical an physical 
coordinates in ONE axis. To manage X axis and Y axis, two different 
CoordinateConverter instances are needed.&]
...
[s2; `=`=> if you want a special conversion, you`'re class has to 
derive from CoordinateConverter&]
[s3; &]
[s0; &]
[ {{10000F(128)G(128)@1 [s0; [* Public Method List]]}}&]
[s4;%- &]
[s5;:Upp`:`:GraphDraw`_ns`:`:CoordinateConverter`:`:IsInGraphVisibleRange`(Upp`:`:GraphDraw`_ns`:`:TypeGraphCoord`)const:%- [@(0.0.255) b
...
[s3; &]
[s4;%- &]
[s5;:Upp`:`:GraphDraw`_ns`:`:CoordinateConverter`:`:AllowZoom`(bool`):%- [@(0.0.255) vo
id]_[* AllowZoom]([@(0.0.255) bool]_[*@3 p]_`=_[@(0.0.255) true])&]
...
[s5;:Upp`:`:GraphDraw`_ns`:`:CoordinateConverter`:`:AllowScroll`(bool`):%- [@(0.0.255) v
oid]_[* AllowScroll]([@(0.0.255) bool]_[*@3 p]_`=_[@(0.0.255) true])&]
...
[s3;%- &]
[s4;%- &]
[s5;:Upp`:`:GraphDraw`_ns`:`:CoordinateConverter`:`:UpdateScreenSize`(Upp`:`:GraphDraw`_ns`:`:TypeScreenCoord`,Upp`:`:GraphDraw`_ns`:`:TypeScreenCoord`):%- [@(0.0.255) i
...
[s3; &]
[s4;%- &]
[s5;:Upp`:`:GraphDraw`_ns`:`:CoordinateConverter`:`:UpdateGraphSize`(Upp`:`:GraphDraw`_ns`:`:TypeGraphCoord`,Upp`:`:GraphDraw`_ns`:`:TypeGraphCoord`):%- [@(0.0.255) i
...
[s3; &]
[s4;%- &]
[s5;:Upp`:`:GraphDraw`_ns`:`:CoordinateConverter`:`:applyRangeLimits`(Upp`:`:GraphDraw`_ns`:`:TypeGraphCoord`):%- [@(0.0.255) v
irtual] TypeGraphCoord_[* applyRangeLimits](TypeGraphCoord_[*@3 v])&]
[s2; Apply logical range limits (in graph coordinates ) to the value 
V.&]
[s2; `=`=> If V is not in authorized range then it is modified to 
be in the range.&]
[s2; Returns the modified value&]
[s3; &]
[s4; &]
[s5;:Upp`:`:GraphDraw`_ns`:`:CoordinateConverter`:`:toScreen`(const Upp`:`:GraphDraw`_ns`:`:TypeGraphCoord`)const:%- [@(0.0.255) v
